...
$(document).ready(function() {
  ...
  //start the animation
    $(".start").click(function(){
      ...
      $(".move1").animate({marginLeft:"84%"},2250,"linear"),$(".move1").animate({marginLeft:"3%"},1800,"linear"),
      $(".move2").animate({marginLeft:"83%"},1900,"linear"),$(".move2").animate({marginLeft:"4%"},1659,"linear"),
      $(".move3").animate({marginLeft:"83%"},2360,"linear"),$(".move3").animate({marginLeft:"4%"},1000,"linear"),
      $(".move4").animate({marginLeft:"83%"},2060,"linear"),$(".move4").animate({marginLeft:"4%"},1260,"linear"),
      $(".move5").animate({marginLeft:"83%"},2890,"linear"),$(".move5").animate({marginLeft:"4%"},1099,"linear");
      }
